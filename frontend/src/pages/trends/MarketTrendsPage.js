        ...
        <>
          ...
          <div className="dashboard-row">
            <section className="analytics-section gainers-section">
              <div className="section-header">
                <h2>{t('analytics.topGainers')}</h2>
                <p>{t('analytics.highestPriceIncrease')}</p>
              </div>
              <div className="horizontal-scroll">
                {topGainers.length > 0 ? (
                  ...
                  <div className="no-data">{t('analytics.noDataSufficient')}</div>
                )}
              </div>
            </section>
            ...
            <section className="analytics-section losers-section">
              <div className="section-header">
                <h2>{t('analytics.topLosers')}</h2>
                <p>{t('analytics.highestPriceDecrease')}</p>
              </div>
              <div className="horizontal-scroll">
                {topLosers.length > 0 ? (
          ...
          <div className="dashboard-row">
            <section className="analytics-section liquidity-section">
              <div className="section-header">
                <h2>{t('analytics.bestLiquidity')}</h2>
                <p>{t('analytics.easiestToTrade')}</p>
              </div>
              <div className="horizontal-scroll">
            ...
            <section className="analytics-section floats-section">
              <div className="section-header">
                <h2>{t('analytics.lowestFloats')}</h2>
                <p>{t('analytics.neariestPerfect')}</p>
              </div>
              <div className="horizontal-scroll">
